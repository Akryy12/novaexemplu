(function ($)
{
  ...
  {
    navigator.clipboard.writeText("NovaCraft.pula.ro").then((Error) => 
    {
      if (Error)
        console.error(Error);
      else 
      {
        Swal.fire(
        {
          ...
          html: "Adresa IP a serverului de Minecraft a fost copiat cu success.",
        });
      }
    });
  });
  ...
  {
    navigator.clipboard.writeText("cs.haos.gg").then((Error) => 
    {
      if (Error)
        console.error(Error);
      else 
  ...
  {
    navigator.clipboard.writeText("minecraft.haos.gg").then((Error) => 
    {
      if (Error)
        console.error(Error);
      else 
  ...
  {
    navigator.clipboard.writeText("metin.haos.gg").then((Error) => 
    {
      if (Error)
        console.error(Error);
      else 
